...
extern void ZFDispatchSyncOnMainThread(dispatch_block_t block);
extern void ZFDispatchAsyncOnMainThread(dispatch_block_t block);
extern void ZFDispatchOnGlobalQueue(dispatch_queue_priority_t priority, dispatch_block_t block);
extern void ZFDispatchOnDefaultQueue(dispatch_block_t block);
extern void ZFDispatchOnHighQueue(dispatch_block_t block);
extern void ZFDispatchOnLowQueue(dispatch_block_t block);
extern void ZFDispatchOnBackgroundQueue(dispatch_block_t block);
/** After `delayTime`, dispatch `block` on the main thread. */
extern void ZFDispatchAfter(NSTimeInterval delayTime, dispatch_block_t block);
