...
{
    // tab bar
    [[UITabBar appearance] setTintColor:kDarkColor333333];
    
    //navigation bar
    NSDictionary * attributes = [NSDictionary dictionaryWithObjectsAndKeys:[CustomFont boldHeiti:18], NSFontAttributeName, kDarkColor333333,NSForegroundColorAttributeName, nil];
