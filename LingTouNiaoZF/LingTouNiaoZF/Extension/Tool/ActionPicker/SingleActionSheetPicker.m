...
//{
//    NSString * value = [esString(self.dataArray[row][@"value"]) stringByAppendingString:esString(self.dataArray[row][@"description"])];
//    return value;
//}
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    value = [value stringByAppendingString:description];
